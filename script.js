document.addEventListener('DOMContentLoaded', () => {
    ...
    sosBtn.addEventListener('click', () => {
        ...
        timerInterval = setInterval(() => {
            ...
            if (count > 0) {
                ...
                alertSimText.textContent = "Authorities and emergency contacts have been notified.";
    ...
    // Start empty, animate to 72%
    setTimeout(() => {
        circle.style.strokeDasharray = "72, 100";
        // Animate number
        let current = 0;
        const target = 72;
    ...
    routeBtn.addEventListener('click', () => {
        ...
        setTimeout(() => {
            routeBtn.innerHTML = '<i class="fa-solid fa-check"></i> Safest Route Found';
